...
for num_f in array_f:
	directory = './Output_MPINNs_examples/ds12_pro2_Darcy/MPINN_pro2_ts5s5_n43n23_opt7_5e4_f'+str(num_f)+'/'
	...
	for ii in range(0,num_data):
		...
		for i_s in rand_seed:
			os.system("python {0} {1} {2} {3} \
				...
				12 1 \
				943 923 912 1 1 1\
				7 0 50000 0.0001 0 1.e-6 'standard' 2 \
				2 {5} 1 0.0005".format(src_dir,directory,i_s,N_s,num_k,rand_seed_mea,num_f))
