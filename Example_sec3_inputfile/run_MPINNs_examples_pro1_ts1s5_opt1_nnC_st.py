...
for i_nn in array_nn:
	for num_c in array_c:
		directory = './Output_MPINNs_examples/ds12_pro1_ts/MPINN_pro1_ts1s5_pro1_nn'+str(i_nn)+'_opt1_st_c'+str(num_c)+'/'  # test main_PINN_CAD_v3 without STD
		...
		for ii in range(0,num_data):
			...
			for i_s in rand_seed:
				os.system("python {0} {1} {2} {3} \
					...
					12 1 \
					{8} {8} {8} 1 1 1\
					1 0 1000000 0.001 0 1.e-6 'standard' 1 \
...
for i_nn in array_nn:
	for num_c in array_c:
		directory = './Output_MPINNs_examples/ds12_pro1_ts/MPINN_pro1_ts1s5_pro1_nn'+str(i_nn)+'_opt7_st_c'+str(num_c)+'/'  # test main_PINN_CAD_v3 without STD
		src_dir   = './main_MPINNs.py' 
		...
		for ii in range(0,num_data):
			...
			for i_s in rand_seed:
				os.system("python {0} {1} {2} {3} \
					...
					12 1 \
					{8} {8} {8} 1 1 1\
					7 0 50000 0.001 0 1.e-6 'standard' 1 \
					2 {7} 1 0.0005".format(src_dir,directory,i_s,N_s,num_k,num_h,num_c,rand_seed_mea,i_nn))
