...
num_data = 1
array_nn  = np.array([636,637,638,639,630,6311,6312,6313,6314,6315])
for i_nn in array_nn:

	directory = './Output_MPINNs_examples_sec4/Corr_pro31_ds51s5/MPINN_ds51_pro31_opt21m1ki600k_nn'+str(i_nn)+'/'  # test main_PINN_CAD_v3 without STD
	...
	for ii in range(0,num_data):
		...
		for i_s in rand_seed:
			os.system("python {0} {1} {2} {3} \
				...
				51 1 \
				{5} 923 923 1 1 1\
				21 1000 600000 0.0002 0 1.e-8 'standard' 31 \
