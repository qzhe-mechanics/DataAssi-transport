...
mainFolder = {  'CADn_v6s2_pro32_ts1s5_n912_opt1',...
                'CADn_v6s2_pro32_ts1s5_n922_opt1',...
                'CADn_v6s2_pro32_ts1s5_n913_opt1',...
                'CADn_v6s2_pro32_ts1s5_n923_opt1'};
            
name_test = 'CADn_v6s2_pro32_ts1s5_nn';

type_pro  = 2; % 1: plot k, 2: plot h; 3: C
type_xlab = 2;  % The x-axis...
type_plot = 2; % 1: only mean; 2: error plot
if_log  = 0;

num_dataset = numel (mainFolder);
N_s = 5; % Number of NNs initialization
x = [8	16	32	48	64	80]; % Measurement point
