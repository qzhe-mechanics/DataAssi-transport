...
if type_pro == 3
    %     C
    mainFolder = {'CADn_v6s5_ts1s5_pro1_nn923_opt1_st_c64',...
        'CADn_v6s4_ts1s5_pro1_nn923_opt1_st_c128',...
        'CADn_v6s5_ts1s5_pro1_nn933_opt1_st_c64',...
        'CADn_v6s5_ts1s5_pro1_nn933_opt1_st_c128',...
        'CADn_v6s5_ts1s5_pro1_nn943_opt1_st_c64',...
        'CADn_v6s4_ts1s5_pro1_nn943_opt1_st_c128'};
else
    % K & h
    mainFolder = {'CADn_v6s1_pro2_ts3s5_n23n13_opt1_f200',...
        'CADn_v6s5_ts1s5_pro1_nn923_opt1_st_c64',...
        'CADn_v6s4_ts1s5_pro1_nn923_opt1_st_c128',...
        'CADn_v6s5_ts1s5_pro1_nn933_opt1_st_c64',...
        'CADn_v6s5_ts1s5_pro1_nn933_opt1_st_c128',...
        'CADn_v6s5_ts1s5_pro1_nn943_opt1_st_c64',...
...
name_test = 'CADn_v6s1_pro1_ts4s5_nn_st02';
