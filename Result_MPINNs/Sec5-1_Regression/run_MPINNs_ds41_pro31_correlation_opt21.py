...
for i_nn in array_nn:
	...
	directory = './Output_MPINNs_examples/ds41_pro31/CADn_v6s3_ds41_pro31_opt21m1ki400k_lr1e3_mea2_Nk20k_nn'+str(i_nn)+'/'  # test main_PINN_CAD_v3 without STD
	...
	for ii in range(0,num_data):
		...
		for i_s in rand_seed:
			os.system("python {0} {1} {2} {3} \
				...
				41 1 \
				{5} 923 923 1 1 1\
				21 1000 400000 0.001 0 1.e-8 'standard' 31 \
...
array_k = np.array([20000])
num_data = 1
array_nn  = np.array([632,633,634,635,636,637,638,639,630])
for i_nn in array_nn:

	directory = './Output_MPINNs_examples/ds41_pro31/CADn_v6s3_ds41_pro31_opt21m1ki400k_lr2e4_mea2_Nk20k_nn'+str(i_nn)+'/'  # test main_PINN_CAD_v3 without STD
