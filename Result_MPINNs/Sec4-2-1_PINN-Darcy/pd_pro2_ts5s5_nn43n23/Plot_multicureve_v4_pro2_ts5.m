...
mainFolder = {  'CADn_v6s1_pro31_ts1s5_n923_opt1',...
                'CADn_v6s1_pro2_ts5s5_n43n23_opt1_h8_f20',...
                'CADn_v6s1_pro2_ts5s5_n43n23_opt1_h8_f100',...
                'CADn_v6s1_pro2_ts5s5_n43n23_opt1_h8_f200',...
                'CADn_v6s1_pro2_ts5s5_n43n23_opt1_h8_f400'};
                
num_dataset = numel (mainFolder);

name_test = 'CADn_v6s2_pro2_ts5s5_n43n23';

type_pro  = 1; % 1: plot k, 2: plot h; 3: C
